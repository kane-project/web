	...
	<main id="main">
		...
		<section class="intro-single">
			<div class="container">
                        ...
                        <div class="card mb-4 p-1 text-light bg-primary rounded-0 shadow">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>Skip ahead of other prospective tenants</li>                                        
                                </ul>
                ...
                <div class="row py-5">
                    <div class="col-md-4">
                        <div class="card mb-4 p-1 bg-bronze text-light rounded-0 shadow">
                            <div class="card-body">
                                <h5 class="card-title">Bronze</h5>
                                <h6 class="card-subtitle mb-2">$2.99 One Time</h6>
                                <ul>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 p-1 text-light bg-silver rounded-0 shadow">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 p-1 rounded-0 shadow bg-gold text-light">
                            <div class="card-body">
