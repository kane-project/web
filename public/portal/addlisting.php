                ...
                <div class="col-lg-6 mx-auto">
                    <form method="post" action="/portal/addlisting" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control rounded-0" id="price" name="price" required>
                        </div>
                        <div class="mb-3">
                            <label for="beds">Number of Beds</label>
                            <input type="number" class="form-control rounded-0" id="beds" name="num_beds" required>
                        </div>
                        <div class="mb-3">
                            <label for="baths">Number of Baths</label>
                            <input type="number" class="form-control rounded-0" id="baths" name="num_baths" required>
                        </div>
                        <div class="mb-3">
                            <label for="description">Description</label>
                            <textarea class="form-control rounded-0" id="description" name="description" required></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="sponsored_tier">Sponsored Tier</label>
